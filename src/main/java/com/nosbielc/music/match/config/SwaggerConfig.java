...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket swaggerPersonApi10() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.nosbielc.music.match.controllers"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Music Match API Rest")
                .description("Music Match em Java.")
                .version("1.0")
