...
import com.nosbielc.music.match.response.Error;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
        ...
        String error = ex.getParameterName() + " Faltando Parametros";
...
//    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        String error = String.format("Malformed JSON request -> %s to %s", servletWebRequest.getHttpMethod(), servletWebRequest.getRequest().getServletPath());
        return buildResponseEntity(new Error(BAD_REQUEST, error, ex));
    }
